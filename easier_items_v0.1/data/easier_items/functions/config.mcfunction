...
tellraw @s [{"text":"3 gold & 3 scraps to 1 netherite : ","color":"aqua"},{"text":"Enable","color":"green","clickEvent":{"action":"run_command","value":"/function armor_statues:shrine/create"}},{"text":" / ","color":"aqua"},{"text":"Disable","color":"red","clickEvent":{"action":"run_command","value":"/function armor_statues:shrine/remove"}}]
